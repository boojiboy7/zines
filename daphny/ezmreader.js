...
/*  
    ...
    8: 64 pages
        Micro
*/
const BGCOLOR = '#ff00e6'; // Change this hex value to set the background color. Remember to keep the quotes!
const ALT = 'daphnyzine'; // Change this to a plaintext copy or description of your content to make it visible to screen-readers
